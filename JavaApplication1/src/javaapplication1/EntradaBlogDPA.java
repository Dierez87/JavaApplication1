 ...
 * @author por Diego Perez Anton.
 * @since La clase se creó el 15/02/2023
 * @version Esta es la versión 2.3
*/
public class EntradaBlogDPA {
    /**
     * Separador
    ...
    */
     ...
     */
	public EntradaBlogDPA (int id,String autor,String texto)throws IllegalArgumentException{
	...
	public static void main(String[] args) {
                //Modificar.
		EntradaBlogDPA e1=new EntradaBlogDPA (-3,"ana","Últimas noticias, está disponible BixBy 2.0");
